...
pub struct SnowBreakGameType;

impl SnowBreakGameType {
    pub fn initialize() -> Vec<D3D11GameType> {
        vec![
            D3D11GameType::from_parts(
                "GPU_P12_TA4_N4_BI4_4_T4_",
                vec![
                    D3D11Element::new(
            ...
            D3D11GameType::from_parts(
                "GPU_P12_TA4_N4_BI4_BW4_T4_T1-4_T2-4_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "GPU_P12_TA4_N4_BI8_BW8_T4_T1-4_T2-4_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "GPU_P12_TA4_N4_C4_BI4_4_T4_T1-4_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "GPU_P12_TA4_N4_C4_BI4_BW4_T4_T1-4_T2-4_T3-4_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "GPU_P12_TA4_N4_C4_BI8_BW8_T4_T1-4_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
