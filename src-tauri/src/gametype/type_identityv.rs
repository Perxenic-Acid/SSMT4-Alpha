...
pub struct IdentityVGameType;

impl IdentityVGameType {
    pub fn initialize() -> Vec<D3D11GameType> {
        vec![
            ...
            D3D11GameType::from_parts(
                "CPU_P12_N12_TA12_C4_T8_T1-8_T2-8_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "CPU_P12_N12_TA12_C4_T8_T1-8_vb0vb1",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "GPU_P12_N12_TA12_C4_T8_T1-8_BW16_BI8_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "GPU_P12_N12_TA12_C4_T8_T1-8_T2-8_BW16_BI8_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
            ...
            D3D11GameType::from_parts(
                "GPU_P12_N12_TA12_C4_T8_T1-8_T2-8_T3-8_BW16_BI8_",
                vec![
                    D3D11Element::new(
                        ElementName::POSITION,
                        DxgiFormat::R32G32B32_FLOAT,
